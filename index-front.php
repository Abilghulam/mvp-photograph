...
<body>
    <header>
        <div class="container">
            <nav class="navbar">
                <a href="index-front.php" class="logo">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="logreg.php" style="color: #ff6b6b;">Log in</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <section class="hero">
        ...
        <div>
            <a href="#layanan" class="btn">Jasa Fotografi</a>
            ...
            <div class="services-container">
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <p>ayakan pencapaian akademik Anda dengan sesi foto profesional. Kami menawarkan paket foto wisuda individual maupun kelompok dengan tema yang diinginkan.</p>
                        <button onclick="alertLogin()" class="btn btn-primary" style="background-color: #ff6b6b; border:none;">Pesan Sekarang</button>
                    </div>
                </div>
                <div class="service-card">
    ...
    <div class="modal-contents">
      ...
      <div class="quick-view-details">
        ...
        <div class="action-buttons">
          <button id="whatsappButton" class="whatsapp-btn" onclick="alertLogin()">
  ...
  <a href="https://wa.me/6285102860099" class="chat-btn" target="_blank">
    ...
    <script src="js/quick-view-front.js"></script>
